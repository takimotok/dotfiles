local M = {
  ...
  mcphub = {
    ...
    opts = {
      make_tools = true, -- ツールを作成
      show_server_tools_in_chat = true, -- チャットに表示
      make_vars = false, -- 変数を作成 (disabled due to nil error in mcphub)
      make_slash_commands = true, -- スラッシュコマンドを作成
      show_result_in_chat = true, -- 結果をチャットに表示
    },
